...
//   const initialNameRef = useRef(contact.name);
//   const initialNumberRef = useRef(contact.number);
...
//         <BtnForm type="submit" isLoading={isLoading} disabled={isLoading || !isModified}>
